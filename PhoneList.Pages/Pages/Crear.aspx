...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-6">
        <asp:Image ID="AvatarImage" runat="server" ImageUrl="../Images/avatar.png" CssClass="content_avatar-mini"/><br /><br />
        ...
        <asp:TextBox ID="txtCompania" runat="server"></asp:TextBox><br /><br />
    </div>
    ...
    <div class="col-md-6">
        ...
        <asp:TextBox ID="txtFecha" runat="server"></asp:TextBox><br /><br />
